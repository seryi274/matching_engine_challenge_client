# Fill this in before your first submission, then run:  python submit.py
#
# TEAM_NAME  Letters, digits, '-' or '_' (max 32 characters). This is the
#            name shown on the leaderboard.
# PASSWORD   Chosen by you on your FIRST submission. Every later submission
...
#
# To try your engine without being scored, run `python check.py` instead.
